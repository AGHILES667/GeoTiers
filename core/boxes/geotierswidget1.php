...
/**
 * \file    geotiers/core/boxes/geotierswidget1.php
 * \ingroup geotiers
 * \brief   Widget provided by GeoTiers
 *
 ...
 */
class geotierswidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "geotiersbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "geotiers@geotiers";
	 ...
	 */
	public $lang = 'geotiers@geotiers';

	/**
	 * @var string[] Module dependencies
	 */
	public $depends = array('geotiers');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// $this->hidden = !$user->hasRight('geotiers', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/geotiers/class/geotiers.class.php");

		// Populate the head at runtime
		$text = $langs->trans("GeoTiersBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_geotiers@geotiers',
